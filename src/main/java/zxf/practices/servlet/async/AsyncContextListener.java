...
public class AsyncContextListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent servletContextEvent) {
        System.out.println("AsyncContextListener::contextDestroyed::Start::Name=" + Thread.currentThread().getName() + "::ID=" + Thread.currentThread().getId());
        ThreadPoolExecutor executor = (ThreadPoolExecutor) servletContextEvent.getServletContext().getAttribute("executor");
        executor.shutdown();
        System.out.println("AsyncContextListener::contextDestroyed::End::Name=" + Thread.currentThread().getName() + "::ID=" + Thread.currentThread().getId());
    }
}